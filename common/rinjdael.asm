...
align dword
rijndael_init proc uses esi edi ebx pKey:DWORD,dwKeyLen:DWORD
	mov esi,pKey
...
align dword
rijndael_encrypt proc uses esi edi ebx pBlockIn:DWORD,pBlockOut:DWORD
...
align dword
rijndael_decrypt proc uses esi edi ebx pBlockIn:DWORD,pBlockOut:DWORD
LOCAL  s0, s1, s2, s3, t0, t1, t2, t3
	mov esi,pBlockIn
	mov edi,offset rk_dec
	mov eax,[esi+0*4]
